    ...
    <section class="login-content">
      ...
      <div class="login-box">
        <form class="login-form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>Loguearse</h3>
          ...
          <div class="row">
            ...
            <div class="text-center">
             ...
             <div class="row col-12 mt-2">
              ...
              <p  class="semibold-text mb-0 "><a href="register.php"><small>No tenés usuario? Registrate</small> </a></p>
          ...
          <div class="form-group btn-container">
            ...
            <button type="submit" name="submit" class="btn btn-primary btn-block">ENTRAR <i class="fa fa-sign-in fa-lg"></i></button>
          </div>
        </form>
