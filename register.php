...
<html>
  ...
  <body style="background: linear-gradient(135deg, #172a74, #21a9af); background-color: #172a74;">
    ...
    <section class="login-content">
      ...
      <div style="min-height:450px;" class="login-box">
        <form class="login-form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
          ...
          <div class="form-group btn-container">
            ...
            <button type="submit" name="submit" class="btn btn-primary btn-block">REGISTRARSE <i class="fa fa-sign-in fa-lg"></i></button>
          </div>
          <div class="row col-12 mt-2 text-center mt-1">
          <p  class="semibold-text mb-0 "><a href="login.php"><small>Volver al login</small> </a></p>             
            </div>
