...
$trabajo1_display = isset($_POST['s3-year']) ? "inline-table" : "none";
$s3_year = isset($_POST['s3-year']) ? $_POST['s3-year'] : "20XX";
$s3_year_end = isset($_POST['s3-year-end']) ? $_POST['s3-year-end'] : "20XX";
    ...
    <body>
        ...
        <div style="padding-left:20px" class="invoice">
            ...
            <table style="display:<?php echo $estudio2_display; ?>" width="100%">
                <thead>
                    <tr>
                        <th width="40%" align="left"><?php echo $s2_year_b; ?></th>
                ...
                <tbody>
                    <tr >
                        <td width="40%" align="left"></td>
                        <td align="left"><?php echo $s2_place_b; ?>.</td>
                    </tr>
                </tbody>
            </table>
            <!-- cualificacion #3 -->
            <table style="display:<?php echo $estudio3_display; ?>" width="100%">
                <thead>
                    <tr>
                        <th width="40%" align="left"><?php echo $s2_year_c; ?></th>
                ...
                <tbody>
                    <tr >
                        <td width="40%" align="left"></td>
                        <td align="left"><?php echo $s2_place_c; ?>.</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div style="padding-left:20px" class="invoice">
            ...
            <table style="display:<?php echo $trabajo1_display; ?>" width="100%">
                <thead>
                    <tr >
                        <th width="40%" align="left"><?php echo $s3_year; ?>-<?php echo $s3_year_end; ?></th>
                        <th align="left"><?php echo $s3_position; ?>
                            -
                            <?php echo $s3_place; ?>
                            ESTADO</th>
                    </tr>
                ...
                <tbody>
                    <tr >
                        <td width="40%" align="left"></td>
                        <td align="left"><?php echo $s3_tasks; ?>.</td>
                    </tr>
                </tbody>
            </table>
            <!-- trabajo #2 -->
            <table style="display:<?php echo $trabajo2_display; ?>" width="100%">
                <thead>
                    <tr >
                        ...
                        <th align="left"><?php echo $s3_position_b; ?>
                            -
                            <?php echo $s3_place_b; ?>
                            ESTADO</th>
                    </tr>
            ...
            <table style="display:<?php echo $trabajo3_display; ?>" width="100%">
                <thead>
                    <tr>
                        ...
                        <th align="left"><?php echo $s3_position_c; ?>
                            -
                            <?php echo $s3_place_c; ?>
                            ESTADO</th>
                    </tr>
        ...
        <br>
        <div
            style="padding-left:20px; display:<?php echo $curso1_display; ?>"
            class="invoice">
